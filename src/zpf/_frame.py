...
OPT_TRANSFORM_PARAMS_DIGEST = 0x0015
OPT_URI = 0x0020
OPT_DIGEST = 0x0021
...
OPT_SEQUENCED_BASIS = 0x0053
OPT_EXTERNAL_SESSION_ID = 0x0054
OPT_ENDPOINT = 0x0060
OPT_ISN = 0x0061
OPT_IDENTITY = 0x0062
OPT_TCP_ROLE = 0x0063
...
OPT_REASON_CLASS = 0x00A1
OPT_LABEL = 0x00B0
OPT_LABEL_KIND = 0x00B1
OPT_SESSION_END_REASON = 0x00C0
OPT_INPUT_EXTENTS = 0x00C1
OPT_WIDTH = 0x00D0
OPT_DISCONTINUITY_REASON = 0x00D1
...
INPUT_EXTENT_ENTRY_SIZE = INPUT_EXTENT_ENTRY.size  # 20
MAX_OPTION_VALUE = 0xFFFF
MAX_SPANS_PER_OPTION = MAX_OPTION_VALUE // SPAN_ENTRY_SIZE  # 2340
MAX_EXTENTS_PER_OPTION = MAX_OPTION_VALUE // INPUT_EXTENT_ENTRY_SIZE  # 3276
