...
| Document | What it is |
| --- | --- |
| [`V0.3.0-RELEASE-PLAN.md`](V0.3.0-RELEASE-PLAN.md) | The `0.16` → `0.19` port and the four issues open at `0.2.0` (#58, #59, #62, #63), including the API break that makes `0.3.0` a minor. **Live** — Phases 0 to 5 landed 2026-09-06 (#59, #62, #63 closed); Phase 6 next. |
