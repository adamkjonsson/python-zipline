...
`zpf` is a Python implementation of version 0.16 of the
[Zipline Payload Format](https://github.com/adamkjonsson/zipline/blob/v0.16/docs/zipline-payload-format.md) (`.zpf`):
...
against another rather than misreading it. Everything below describes 0.16.
```
