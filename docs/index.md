...
`zpf` is a Python implementation of version 0.20 of the
[Zipline Payload Format](https://github.com/adamkjonsson/zipline/blob/v0.20/docs/zipline-payload-format.md) (`.zpf`):
...
against another rather than misreading it. Everything below describes 0.20.
```
